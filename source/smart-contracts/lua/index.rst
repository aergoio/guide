...
To create smart contracts for Aergo, you can use the `Lua scripting language <http://www.lua.org/about.html>`_.
...
We use `LuaJIT 2.0.3 <http://luajit.org/luajit.html>`_ as the VM. LuaJIT is a Just-In-Time Compiler (JIT) for the Lua programming language.
